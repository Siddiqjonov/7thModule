...
public class ContactServiceTests
{
    ...
    public async Task AddContactAsync_InvalidContact_ThrowsValidationFailedException()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<ValidationFailedException>( async () => await _service.AddContactAsync(contactCreateDto, userId));
    ...
    public async Task GetAllContactstAsync_ReturnsCollectionOfContacts()
    {
        ...
        var expectedDtos = contacts.Select(c => MapService.ConvertToContactGetDto(c)).ToList();
    ...
    public async Task GetContactByContactIdAsync_UserOwnsContact_ReturnsContactDto()
    {
        ...
        var expectedDto = MapService.ConvertToContactDto(contact);
