...
namespace ContactManager.Infrastructure.Migrations
{
    ...
    [Migration("20250531043745_InitialCreateion")]
    partial class InitialCreateion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContactManager.Domain.Entities.UserRole", b =>
                {
                    b.Property<long>("UserRoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ContactManager.Domain.Entities.User", b =>
                {
                    b.HasOne("ContactManager.Domain.Entities.UserRole", "UserRole")
                        .WithMany("Users")
